...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-expand-md navbar-light bg-warning bg-gradient fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Fresh Pages Book Store</a>
            </div>
            <div class="collapse navbar-collapse" id="topNav">
                <ul class="nav navbar-nav">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="user_register.php"><span class="fa fa-user-plus"></span> Create Account</a></li>
                        <!-- Book Rating Link -->
                        <li class="nav-item"><a class="nav-link" href="user_rating.php"><span class="fa fa-star"></span> Rate This Book</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <h1>Welcome to the most convenient online book store</h1>
        <hr>
    </div>
    <?php } ?>
